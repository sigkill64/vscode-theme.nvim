-- vscode_theme.nvim color scheme
-- Lua port of https://github.com/tomasiser/vim-code-dark
-- By http://github.com/mofiqul
local vscode_theme = {}
local config = require('vscode_theme.config')
local theme = require('vscode_theme.theme')
local utils = require('vscode_theme.utils')
...
vscode_theme.load = function(style)
    ...
    if config.opts.terminal_colors then
        utils.terminal(require('vscode_theme.colors').get_colors())
    end
